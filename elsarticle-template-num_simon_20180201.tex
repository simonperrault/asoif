...
We conducted three design workshops, each of which involved two designers. Each workshop started with an initial ice-breaking session in which the facilitator introduced the concept of in-ring spatial thermal feedback and the purpose of the workshop. The designers then [to be continued...]

Six categories of application that could potentially benefit from thermal feedback were derived from the literature [XXX]: Navigation, Call/Message Notification, Emotion Representation, Rendering the properties of artefacts, Gaming, and Calendar. The designer
