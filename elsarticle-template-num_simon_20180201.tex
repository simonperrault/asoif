...
\item Empirical study on user perception of spatial thermal patterns on the finger using a smart ring.
...
\begin{figure}[h]
  ...
  %\subfigure\cite{]{\label{fig:fold2}\includegraphics[width=0.45\textwidth]{images/wo_assembly.png}}
  \caption{Accuracy of Individual Element Identificantion for the 4-TEC setting. Blue: cold stimulation, Red: hot stimulation.}
  \label{fig:7}
\end{figure}
...
\bibitem{Stevens1998}
Joseph C. Stevens and Kenneth K. Choo. 1998. Temperature sensitivity of the body surface over the life span. In Somatosensory \& Motor Research 15, 1:13-28.
\bibitem{Machado2008}
